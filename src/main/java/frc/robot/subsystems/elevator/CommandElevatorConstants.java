...
public class CommandElevatorConstants {
    ...
    private static final Voltage kg = Volts.of(0.5786070732297333);
    private static final Measure<? extends PerUnit<VoltageUnit, LinearVelocityUnit>> kv = Volts.per(MetersPerSecond).of(3.7203826250617302);
    private static final Measure<? extends PerUnit<VoltageUnit, LinearAccelerationUnit>> ka = Volts.per(MetersPerSecondPerSecond).of(0.05904153808466666);
    private static final double positionKp = 33.07071282487345;
    private static final double positionKd = 1.3498790254001252;
    private static final double velocityKp = 1.2269510983926224;
