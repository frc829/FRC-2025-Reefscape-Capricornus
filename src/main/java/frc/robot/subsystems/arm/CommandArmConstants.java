...
public class CommandArmConstants {
    ...
    public static CommandArm createCommandArm() {
        ...
        talonFXConfiguration.Slot0.kP = positionKp * 2 * Math.PI;
        talonFXConfiguration.Slot0.kD = positionKd * 2 * Math.PI;
        talonFXConfiguration.Slot0.kS = ks.baseUnitMagnitude();
        talonFXConfiguration.Slot0.kV = kv.baseUnitMagnitude() * 2 * Math.PI;
        talonFXConfiguration.Slot0.kA = ka.baseUnitMagnitude() * 2 * Math.PI;
        ...
        talonFXConfiguration.Slot1.kP = velocityKp * 2 * Math.PI;
